  ...
  return (
    <div className="w-full h-full bg-black" id="testimony">
      <div className="container">
        ...
        <div className="xxxs:mt-14 p-0 md:mt-30 px-10">
          <div className="flex flex-col gap-40">
            {test.map((testimony, idx) => (
              <ParallaxProvider key={idx}>
                <Parallax speed={1} translateX={["-300px", "1000px"]}>
                  <div id="testimony" className="flex flex-col gap-4 lg:px-36">
                    <div className="flex gap-10">
                      ...
                      <div className="flex flex-col ">
                        <h1
                          className={` text-white font-sub text-justify xxxs:text-lg tracking-tighter md:text-3xl lg:text-6xl
