        ...
        <div className="fine-works-container mx-auto max-w-full">
          <div className="w-full">
            <div className="bg-cover bg-fine bg-no-repeat flex justify-center h-[20rem] ">
              <div
                className="message   flex flex-col gap-y-4 justify-center text-center w-4/5 lg:w-1/2 text-white"
                data-aos="zoom-in"
              >
                <div className="font-bold text-justify text-base xxs:text-2xl md:text-4xl lg:text-6xl mx-auto" data-aos="fade-up">
                  Fine Works
                </div>
