...
const IntroLanding: FC = () => {
  return (
    <div id="home" className="container bg-black h-screen mx-auto max-w-max ">
      <div className="text-container h-96 flex justify-center items-center w-full mt-20">
        <div className="intro-text text-white md:text-8xl font-bold w-2/3">
          <div className="lg:w-full md:text-4xl lg:text-8xl flex flex-wrap h-5/6 justify-center text-center">
            <div className="text-5xl lg:text-8xl">Meet your next</div>
            <div data-aos="fade-up-right" className="gradient-text">
              creative
            </div>
      ...
      <div className="line-container flex flex-col items-center gap-10">
